...
export class TablaProductosView {
  ...
  renderTable() {
    return `
          <!-- Tabla de Productos (Componente Extraído) -->
   ...
   * @param {Array} productosData - Datos obtenidos del modelo asíncrono.
   */
  initDataTable(productosData) {
    const config = {
      data: productosData,
      destroy: true,
      info: false,
      ...
      columns: [
        ...
        { 
          ...
          render: function (data) {
            ...
            if (data === "Bajo Stock") badgeClass = "badge-low";
            else if (data === "Crítico") badgeClass = "badge-critical";
    ...
    new DataTable("#productos-table", config);
  }
}
