...
description: Regla de Guía de Estilos y Diseño UI (CSS/HTML). Esta regla la aplicará el modelo ("Model Decision") cuando se le solicite diseñar, escribir o modificar la interfaz de usuario, componentes HTML o estilos CSS del proyecto WARESmart.
---
